...
const routes: Routes = [
  ...
  {path: ':{id}', component: FormComponent, resolve: {employee: EmployeeResolve}},
];
...
@NgModule({
  ...
  imports: [
    ...
    MatFormFieldModule,
    ReactiveFormsModule,
    MatFormFieldModule, MatInputModule, MatCheckboxModule, MatButtonModule, MatSelectModule, MatRadioModule
  ],
